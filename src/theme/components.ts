   ...
   MuiDataGrid: {
      styleOverrides: {
         root: {
            ...
            '& .highlight-cell-FPA, .highlight-cell-adjusted, .highlight-cell-baseYear': {
               backgroundColor: 'rgba(255, 204, 153, 0.6)',
            },
            '& .MuiDataGrid-row:nth-child(even) .highlight-cell-FPA , .MuiDataGrid-row:nth-child(even) .highlight-cell-adjusted, .highlight-cell-baseYear ':
               {
            ...
            '& .MuiDataGrid-columnHeaders .pricing-team, .MuiDataGrid-columnHeaders .origin, .highlight-cell-compareYear':
               {
                  backgroundColor: 'rgba(232, 192, 86, 0.8)',
            ...
            '& .highlight-cell-light-green': {
               backgroundColor: '#1F937E',
            },
            '& .highlight-cell-light-red': {
               backgroundColor: '#F27995',
            },
         },
      },
   },
